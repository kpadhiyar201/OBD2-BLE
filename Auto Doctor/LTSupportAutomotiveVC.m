//
//  LTSupportAutomotiveVC.m
//  Auto Doctor
//
//  Created by Vijay on 09/10/21.
//

#import "LTSupportAutomotiveVC.h"

@interface LTSupportAutomotiveVC ()
...
@implementation LTSupportAutomotiveVC
{
...
-(void)onDisconnectAdapterClicked:(id)sender
{
    [self disconnect];
}
